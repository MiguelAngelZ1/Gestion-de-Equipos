...
const SoporteDeleteModal = ({ isOpen, tarea, onClose, onConfirm }) => {
        ...
        >
          ...
          >
            ...
            <div className="p-8 relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="text-2xl font-black text-white tracking-tight mb-3">Eliminar Tarea</h3>
              <p className="text-slate-400 text-sm mb-8 leading-relaxed">
                 ¿Estás totalmente seguro que deseas eliminar el registro de soporte del equipo <span className="text-white font-bold bg-white/5 px-2 py-0.5 rounded border border-white/10">{tarea.equipo_id}</span> a cargo de <strong className="text-white">{tarea.responsable_id}</strong>?
                 <br/><br/>
                 <span className="text-rose-400 font-semibold mt-1 inline-block">Esta acción no se puede deshacer.</span>
              </p>
...
export default SoporteDeleteModal;
