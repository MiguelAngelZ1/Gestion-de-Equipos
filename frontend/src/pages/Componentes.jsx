                    ...
                    <AnimatePresence>
                        {filtered.map(comp => (
                                <CommonCard
                                    ...
                                    extraActions={
                                       <button 
                                          onClick={() => { setComponenteForHistory(comp); setIsHistoryOpen(true); }}
                                          className="p-2 hover:bg-white/10 rounded-xl text-slate-400 hover:text-indigo-400 transition-all cursor-pointer"
