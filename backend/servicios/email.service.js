...
const sendRecoveryCode = async (to, code) => {
    ...
    try {
        ...
        if (!user || !pass) {
            console.warn("⚠️ Email no configurado. El código de recuperación es:", code);
        ...
        throw new Error("No se pudo enviar el correo de recuperación. Verifica las credenciales.");
    }
};
