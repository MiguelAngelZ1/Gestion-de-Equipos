...
function calcularHashEquipo(equipo) {
  const data = `${equipo.id}|${equipo.ine}|${equipo.nne}|${equipo.serie}|${equipo.categoria_id}|${equipo.estado_id}|${equipo.ubicacion_id}|${equipo.responsable_id}|${equipo.is_deleted}`;
