...
router.post('/redes', verificarAutenticacion, async (req, res, next) => {
    try {
...
router.put('/redes/:id', verificarAutenticacion, async (req, res, next) => {
    try {
...
router.delete('/redes/:id', verificarAutenticacion, async (req, res, next) => {
    try {
...
router.post('/redes/:id/reservar', verificarAutenticacion, async (req, res, next) => {
    try {
...
router.delete('/liberar/:ip', verificarAutenticacion, async (req, res, next) => {
    try {
...
router.post('/asignar', verificarAutenticacion, async (req, res, next) => {
    try {
...
router.post('/desvincular', verificarAutenticacion, async (req, res, next) => {
    try {
...
router.post('/exportar-drive', verificarAutenticacion, async (req, res, next) => {
    try {
