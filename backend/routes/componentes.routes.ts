...
router.get('/', verificarAutenticacion, componentesController.getComponentes);
...
router.get('/instalados/:equipo_id', verificarAutenticacion, componentesController.getComponentesInstalados);
router.get('/movimientos/:id', verificarAutenticacion, componentesController.getMovimientosStock);
